...
Welcome to my portfolio! Here you’ll find projects that demonstrate **databases, API testing, and frontend automation**.  
...
## Skills Demonstrated
- SQL & PL/SQL (database design, procedures, triggers)  
- API testing with Postman (functional, negative, performance)  
- Frontend development & UI automation with Cypress  
- Validation, error handling, and persistence  
